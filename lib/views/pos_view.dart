...
class _PosViewState extends State<PosView> {
  ...
  void _completeCheckout() async {
    ...
    for (var cartItem in _cart) {
      ...
      if (pIdx >= 0) {
        ...
        await LocalDbService.instance.updateStock(
            widget.products[pIdx].id, widget.products[pIdx].stockQuantity);
      }
    }
    ...
    if (_paymentMethod == 'CREDIT' && _customerPhoneController.text.isNotEmpty) {
  ...
  void _sendCreditWhatsAppNudge(String phone, String name, double amount) async {
    final message =
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text('KES ${cartTotal.toStringAsFixed(0)}',
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: const Text('Complete & Receipt',
